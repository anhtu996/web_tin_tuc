                ...
                <div class="panel panel-default">
				  	...
				  	<div class="panel-body">
				    	...
				    	<form action="taikhoan" method="POST">
				    		<div>
				    			<label>Họ tên</label>
							  	<input type="text" value="{{ Auth::user()->name }}" class="form-control" placeholder="Username" name="name" aria-describedby="basic-addon1">
							</div>
							<br>
							<div>
				    			<label>Email</label>
							...
							<br>	
							<div>
								<input type="checkbox" id="changePass" class="changePass" name="changePass">
